...
class IMS:
     def __init__(self,root):
          ...
          #===Left Menu=====
          self.MenuLogo=PhotoImage(file="images/menu_im1.png")
          ...
          #===footer=====
          lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by Anisha & Meghna\n For any Technical Issue Contact:6000766143",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
