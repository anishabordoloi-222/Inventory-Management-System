...
class employeeClass:
    def __init__(self,root):
        ...
        txt_lbl_empid=Entry(self.root,textvariable=self.var_emp_id,font=("goudy old style",15),bg="lightyellow").place(x=150,y=150,width=180)
            ...
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete","Employee Deteled Successfully",parent=self.root)
                        self.clear()
