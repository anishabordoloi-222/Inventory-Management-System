...
class supplierClass:
    def __init__(self,root):
        ...
        lbl_supplier_invoice=Entry(self.root,textvariable=self.var_sup_invoice,font=("goudy old style",15),bg="lightyellow").place(x=180,y=80,width=180)
            ...
            if self.var_sup_invoice.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete","Supplier Deteled Successfully",parent=self.root)
                        self.clear()
    ...
    def search(self):
        ...
        try:
            if self.var_searchtxt.get()=="":
                ...
                cur.execute("select * from supplier where invoce=?",(self.var_searchtxt.get(),))
                row=cur.fetchone()
                if row!=None:
