...
class BillClass:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | Developed by Anisha & Meghna")
        ...
        #===bth_logout===
        btn_logout=Button(self.root,text="Logout",command=self.logout,font=("times new roman",15,"bold"),bg="yellow",cursor="hand2").place(x=1150,y=10,height=30,width=150)
        ...
        self.lbl_net_pay=Label(billMenuFrame,text="Net Pay\n[0]",font=("goudy old style",15,"bold"),bg="#607d8d",fg="white")
        ...
        #=============Footer============
        footer=Label(self.root,text="IMS-Inventory Management System | Developed By Anisha & Meghna\n For any Technical Issue contact: 6000766143",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#========================All functions======================
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ-Inventory
\t Phone No. 6000766143 , Guwahati-781001
{str("="*47)}
